...
export default class MongoDatabase {
    ...
    private static get uri(): string {
        let shellString = "mongodb://chrismarquez:Csma0012@";
        shellString += "cluster0-shard-00-00-crrrc.mongodb.net:27017,";
        shellString += "cluster0-shard-00-01-crrrc.mongodb.net:27017,";
        shellString += "cluster0-shard-00-02-crrrc.mongodb.net:27017/";
        shellString += "<database>?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin";
    ...
    public static async create(document: any, collection: string): Promise<boolean> {
        const operation = MongoDatabase.database
    ...
    public static async exists(query: any, collection: string): Promise<boolean> {
        const count = MongoDatabase.database
        .collection(collection)
        .count(query);
